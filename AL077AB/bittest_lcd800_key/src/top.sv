// 800x480 LCD 彩条显示 + 双编码器按键顶层模块，RGB输出改为时序逻辑（嵌套if）
// 更新日志
//260730 V1.0.0 deepseek 初始版本（基于top.v重构，按code_style风格重写，RGB改为时序逻辑）
//260825 v1.1.0 适配800x480@60Hz 33MHz
//260825 v1.2.0 移植XI050CD bittest_lcd800_key：新增双编码器按键A/B，方块控制
...
////////////////////                 参数（内部使用）         /////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
localparam PIXEL_NUM = 800;               // 水平像素数
